 ...
 */
define('MONGO_CONNECTION', 'mongodb://qilife_qilife:jGI3xRMavVc2@127.0.0.1:27017/qilife_qilife_qilife');
define('DB', 'qilife_qilife_qilife');
/**
...
class moadminModel {
     ...
     */
    public static $dbName = 'qilife_qilife_qilife';
    ...
    protected function _mongo() {
        ...
        return (!REPLICA_SET ? new MongoDB\Client($connection) : new MongoDB\Client($connection, array('replicaSet' => true)));
    }
     ...
     * @param string $db
     */
    public function __construct($db = null) {//echo $db;exit;
