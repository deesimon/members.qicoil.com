...
if (!empty($_POST)) {
  ...
  if ($_POST['page_type'] == 2) {
    if ($addAmount == '37') {
      $prduct_id = PRODUCT_QUANTUM_MONTHLY_3;
      $planType = 'monthly';
    } elseif ($addAmount == '497') {
      $prduct_id = PRODUCT_QUANTUM_LIFETIME_3;
      $planType = 'lifetime';
    }
    $productType = 'quantum';
  } elseif ($_POST['page_type'] == 3) {
    if ($addAmount == '97') {
      $prduct_id = PRODUCT_HIGHER_QUANTUM_MONTHLY_3;
      $planType = 'monthly';
    } elseif ($addAmount == '1997') {
      $prduct_id = PRODUCT_HIGHER_QUANTUM_LIFETIME_3;
      $planType = 'lifetime';
    }
