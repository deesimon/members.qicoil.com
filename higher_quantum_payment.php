...
$update_plan = 'https://apiadmin.qienergy.ai/api/frequencies?category=3';
  ...
  <section id="payment">
    <div class="container">
      <div class="row">
        ...
        <?php if (in_array(3, $_SESSION['category_ids'])) { ?>
          <div class="col-md-8 col-md-offset-3">
            <div class="col-md-9" id='d1'>
              <h3> You already purchased this higher quantum subscription.</h3>
            </div>
          </div>
        <?php } else { ?>
          <div class="col-md-8 col-md-offset-3 ss">

            <div class="col-md-9" id='d1'>
              <h3> Higher Quantum Frequencies </h3>
              ...
              <div class="btn_box d-flex q_border">
                ...
                <span class="save">Save Up To $167</span>
                </button>
              </div>


              <div class="price_detail p-4 col-md-12 q_color">
                <h3>$<span class="price1">97 / mo</span> </h3>
            ...
            <div class="col-md-9 mt-3 mb-4">
              ...
              <form action="" method="POST" id="form">
                <input type="hidden" name="add_amount" id="add_amount" value="97">
            ...
            <input id="expirationdate"   name="expirydate" class="form-control input"  placeholder="MM / YY" type="text" pattern="[0-9]*" inputmode="numeric">
                ...
                <!-- <span class="payment_btn col-md-12 mb-3 p1 pri q_color" name="amount"> Total = $997 </span> -->
    ...
    $(document).ready(function() {
      ...
      $('.year_mo').click(function() {
        ...
        if ($(this).hasClass('b2')) {
          var amount = '997 ';
          var p1 = '83 / mo';
          var p2 = '$997 billed annually';
          var btn_text = 'Subscribe';
          var btn_price = 'Total = $997 ';
        } else {
          var amount = '97';
          var p1 = '97 / mo';
           var p2 = '';
          var btn_text = 'Subscribe';
          var btn_price = 'Total = $97';
        }
      ...
      $("#submitbtn").click(function(event) {
        ...
        $.ajax({
          url: "higher_quantum_payment.php",
          type: "POST",
          data: data,
          dataType: 'json',
