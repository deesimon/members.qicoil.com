...
// Live IDs And API Keys ########################################################

define('STRIPE_MODE', '0');
define('PRODUCT_RIFE_MONTHLY', 'price_1LUl2SK3DPNzo53B4gktI6aH');
define('PRODUCT_RIFE_YEARLY', 'price_1LUl39K3DPNzo53BiQ1iT7b3');
define('PRODUCT_QUANTUM_MONTHLY', 'price_1Lxha8K3DPNzo53BbWYJ4Bsu');
define('PRODUCT_QUANTUM_YEARLY', 'price_1LxhbzK3DPNzo53BXC9Pyk3l');
define('PRODUCT_HIGHER_QUANTUM_MONTHLY', 'price_1LeuJrK3DPNzo53BU5310YsY');
define('PRODUCT_HIGHER_QUANTUM_YEARLY',  'price_1LeuKeK3DPNzo53BnWWtWQQn');
define('PRODUCT_INNER_CIRCLE_MONTHLY', 'price_1LuUfdK3DPNzo53B8KFN55Cn');
define('PRODUCT_INNER_CIRCLE_YEARLY',  'price_1LuUiqK3DPNzo53BFlRqdxI8');
define('STRIPE_SECRET_KEY', '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');
...
// define('PRODUCT_RIFE_MONTHLY', 'price_1LuVUFK3DPNzo53BjhADETwj');
// define('PRODUCT_RIFE_YEARLY', 'price_1LuVWoK3DPNzo53BlaC9A17U');
// define('PRODUCT_QUANTUM_MONTHLY', 'price_1LUlEBK3DPNzo53BqNRx1pW5');
// define('PRODUCT_QUANTUM_YEARLY', 'price_1LUlEaK3DPNzo53BW7m3fKwz');
// define('PRODUCT_HIGHER_QUANTUM_MONTHLY', 'price_1LeuG4K3DPNzo53B0TT57PHD');
// define('PRODUCT_HIGHER_QUANTUM_YEARLY',  'price_1LeuI1K3DPNzo53BBP38NrJq');
// define('PRODUCT_INNER_CIRCLE_MONTHLY', 'price_1LuUkNK3DPNzo53Btb1dpc7u');
// define('PRODUCT_INNER_CIRCLE_YEARLY',  'price_1LuUkfK3DPNzo53BaiSBG3ar');

// define('STRIPE_SECRET_KEY', 'sk_test_51Iay8cK3DPNzo53BkvJu9ahJbvrsXNAAJ0B9f1YPIneUOi4iZbFbgfAlulXBFh2x1F6pjJAy7QWHCX2irR9vlACJ00r2oDLebD');
// define('STRIPE_PUBLISHER_KEY', 'pk_test_51Iay8cK3DPNzo53BePl1P4UNgu9nZSbKHVwoO5yszdpWRlfqWtCrKjNnGCyBCX3GVLqE70uMrIQezxMMufloUkhU00675iYe53');

define('RIFE_PAYMENT_URL', 'payment.php?type=1');
