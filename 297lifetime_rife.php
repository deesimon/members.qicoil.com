          ...
          <div class="col-md-6 fan">
            <div class="col-md-12" id='d1'>
              ...
              <div class="btn_box d-flex row-fluid">
                <button type="button" class="btn  col-md-12 b2 year_mo col-xs-6 btnrife">Lifetime
            ...
            <div class="col-md-12 mt-3 mb-4">
              ...
              <form action="" method="POST" id="form">
                <input type="hidden" name="add_amount" id="add_amount" value="297">
