...
if (!empty($_POST)) {
  ...
  if ($_POST['page_type'] == 1) {
    if ($addAmount == '19') {
      $prduct_id = PRODUCT_RIFE_MONTHLY_NEW;
      $planType = 'monthly';
    } elseif ($addAmount == '297') {
      $prduct_id = PRODUCT_RIFE_LIFETIME;
      $planType = 'lifetime';
    }
    $productType = 'rife';
  } elseif ($_POST['page_type'] == 2) {
    if ($addAmount == '47') {
      $prduct_id = PRODUCT_QUANTUM_MONTHLY_NEW;
      $planType = 'monthly';
    } elseif ($addAmount == '997') {
      $prduct_id = PRODUCT_QUANTUM_LIFETIME;
      $planType = 'lifetime';
    }
    $productType = 'quantum';
  } elseif ($_POST['page_type'] == 3) {
    if ($addAmount == '147') {
      $prduct_id = PRODUCT_HIGHER_QUANTUM_MONTHLY_NEW;
      $planType = 'monthly';
    ...
    if ($addAmount == '297') {
      $prduct_id = PRODUCT_VIP_MONTHLY;
      $planType = 'monthly';
    } elseif ($addAmount == '2997') {
      $prduct_id = PRODUCT_VIP_LIFETIME;
      $planType = 'lifetime';
    }
    $productType = 'vip';
  }
